...
public class kakaoController {
	public static JsonNode getAccessToken(String autorize_code) {
		...
		postParams.add(new BasicNameValuePair("client_id", "11e54f2717eee8a42cccebca471198b0")); // REST API KEY
		postParams.add(new BasicNameValuePair("redirect_uri", "kakaoLoginOk.jsp")); // 리다이렉트 URI
